...
const GridProducts: React.FC<GridProductsProps> = () => {
  ...
  return (
    <div className="gap-4 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-cols-1 p-5 justify-center items-star h-[90vh] overflow-y-auto scrollbar-custom md:w-3/4">
      {loading
