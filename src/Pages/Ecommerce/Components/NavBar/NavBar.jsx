            ...
            >
              ...
              <Nav className="flex-row justify-content-around align-items-center mt-2">
                <Nav.Link href="#action1">
                  <div
                    className={`flex-column d-flex justify-content-center align-items-center mt-2 me-3 ${style.divIcon}`}
                  >
                    <svg
                      width="22"
                      height="20"
                ...
                <Nav.Link href="#action2">
                  <div
                    className={`flex-column d-flex justify-content-center align-items-center mt-2 ${style.divIcon}`}
                  >
                    <svg
                      width="22"
                      height="19"
